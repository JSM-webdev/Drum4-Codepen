...
const DrumControl = ({ stop, name, power, volume, handleVolumeChange, changeSoundGroup }) => /*#__PURE__*/
...
React.createElement("button", { onClick: changeSoundGroup }, "Change Sound Group"));
